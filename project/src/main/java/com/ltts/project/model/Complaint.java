...
public class Complaint implements Serializable{
	...
	public Complaint(String complaintDescription, String complaintIncharge, String complaintSubject, String complaintType, String requestStatus, Date date, String comid) {
		super();
	...
	public String toString() {
		return "Complaint [complaintDescription=" + complaintDescription + ", complaintIncharge=" + complaintIncharge
				...
				+ requestStatus + ", date=" + date + ", comid=" + comid + "]";
	}
