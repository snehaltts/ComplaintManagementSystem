...
//    }
	...
	//	ApplicationContext ac=new ClassPathXmlApplicationContext();
		Complaint c=new Complaint(complaintDescription, complaintIncharge, complaintSubject, complaintType, requestStatus, d, empid, comid);
...

	{
		ModelAndView mv = null;
		String complaintDescription = req.getParameter("complaintDescription");
		String complainIncharge = req.getParameter("complaintIncharge");
		String complaintSubject = req.getParameter("complaintSubject");
		String complaintType = req.getParameter("complaintType");
		String date=req.getParameter("date");
		Date d=Date.valueOf(date);
		...
		Complaint c=new Complaint(complaintDescription, complainIncharge, complaintSubject, complaintType, requestStatus, d, empid, comid);
		System.out.println("***** INSIDE CONTROLLER ****"+c);
		boolean b=cd.InsertComplaint(c);
		if(b==false) {
			mv=new ModelAndView("success");
	...
	public ModelAndView updateComplaint(HttpServletRequest req, Model model) {
		...
		Member e = md.getMemberById(empid);
